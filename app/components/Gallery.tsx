    ...
    <section id="galerie" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <h2 className="text-5xl font-bold mt-4">Naše práce</h2>

          <p className="text-gray-500 mt-5 max-w-2xl mx-auto">
            Klikněte na fotografii pro zobrazení ve velkém formátu.
          </p>
        </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition flex items-end">
                <div className="p-6 text-white text-left">
                  ...
                  <p className="text-sm text-gray-200">Zobrazit detail</p>
                </div>
              </div>
            </button>
          ))}
